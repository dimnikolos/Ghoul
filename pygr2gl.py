...
#
#
##This program is modified under the terms of the GNU General Public License
##Its original version was 0.1
##Original source code of this project can be found in
##http://www.g-loaded.eu/2006/12/18/pygr2gl-greek-to-greeklish-converter/
# 
# Original Header
###############################################################################
